...
exports.run = async (client, message, args) => {
    if (!message.member.permissions.has("ADMINISTRATOR")) {
        message.reply(`Você não pode executar esse comando`)
    } else {
        ...
        let embed_i = new MessageEmbed()
            ...
            .setColor("#FFC280")
            .setDescription(`${message.author} Qual será a imagem do embed? Caso não queira use essa https://i.imgur.com/ZwLaa1O.png`);
        let embed_t = new MessageEmbed()
            ...
            .setColor("#FFC280")
            .setDescription(`${message.author} Qual será a thumbnail do embed? Caso não queira use essa https://i.imgur.com/ZwLaa1O.png`);
        let embed_if = new MessageEmbed()
            ...
            .setColor("#FFC280")
            .setDescription(`${message.author} Qual será a imagem footer do embed? Caso não queira use essa https://i.imgur.com/ZwLaa1O.png`);
        ...
        let embed_footer = new MessageEmbed()
            ...
            .setColor("#FFC280")
            .setDescription(`${message.author} Qual o footer do embed?`);
        ...
        let embed_men = new MessageEmbed()
            ...
            .setColor("#FFC280")
            .setDescription(`${message.author} Deseja mencionar todos? sim ou não`);
        ...
        let embed_cor = new MessageEmbed()
            ...
            .setColor("#FFC280")
            .setDescription(`${message.author} Qual a cor do embed?`);

        message.reply({embeds: [embed_1]}).then(msg => {
            let coletor_1 = message.channel.createMessageCollector({
            ...
            coletor_1.on("collect", (palavra_1) => {
                ...
                if (!chat) {
                    ...
                    if (chat) {
                        msg.edit({embeds: [embed_2]}).then(m_2 => {
                            ...
                            coletor_2.on("collect", (palavra_2) => {
                                ...
                                m_2.edit({embeds: [embed_3]}).then(m_3 => {
                                    coletor_3.on("collect", (palavra_3) => {
                                        ...
                                        let coletor_5 = message.channel.createMessageCollector({
                                            filter: mm => mm.author.id == message.author.id,
                                            max: 1
                                        });
                                        ...
                                        m_3.edit({embeds: [embed_t]}).then(m_5 => {
                                            coletor_5.on("collect", (palavra_5) => {
                                                ...
                                                let coletor_6 = message.channel.createMessageCollector({
                                                    filter: mm => mm.author.id == message.author.id,
                                                    max: 1
                                                });
                                                m_5.edit({embeds: [embed_i]}).then(m_6 => {
                                                    coletor_6.on("collect", (palavra_6) => {
                                                        ...
                                                        let coletor_7 = message.channel.createMessageCollector({
                                                            filter: mm => mm.author.id == message.author.id,
                                                            max: 1
                                                        });
                                                        m_6.edit({embeds: [embed_if]}).then(m_7 => {
                                                            coletor_7.on("collect", (palavra_7) => {
                                                                ...
                                                                let coletor_8 = message.channel.createMessageCollector({
                                                                    filter: mm => mm.author.id == message.author.id,
                                                                    max: 1
                                                                });
